...
const STATUS_CONFIG: Record<FileStatus, { label: string; bg: string; text: string; ring: string }> = {
  ...
  different: { label: 'Różny rozmiar', bg: 'bg-amber-500/15', text: 'text-amber-600 dark:text-amber-400', ring: 'ring-1 ring-amber-400/20' },
  error404: { label: 'Błąd 404', bg: 'bg-rose-500/15', text: 'text-rose-600 dark:text-rose-400', ring: 'ring-1 ring-rose-400/20' },
  new: { label: 'Nowy plik', bg: 'bg-blue-500/15', text: 'text-blue-600 dark:text-blue-400', ring: 'ring-1 ring-blue-400/20' },
