...
export default function ComparisonForm({ onRun, isRunning }: ComparisonFormProps) {
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 shadow-lg shadow-black/20 backdrop-blur sm:p-6">
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_1fr_auto]">
        <div>
          <label className="mb-1.5 block text-sm font-medium text-slate-300">
            Stary adres BIP
          </label>
          <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-slate-900/60 px-3 py-2.5 focus-within:border-violet-500 focus-within:ring-2 focus-within:ring-violet-500/20">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-slate-900/60 px-3 py-2.5 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20">
            <Link2 size={16} className="shrink-0 text-slate-500" />
            <input
              value={newUrl}
      ...
      <div className="mt-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <span className="mb-1.5 block text-sm font-medium text-slate-300">Zakres testu</span>
