...
- Name: visual-compare.spec.ts >> Porównanie wizualne stron BIP >> Porównanie dla: zamowienia
...
Error: expect(Buffer).toMatchSnapshot(expected) failed
  ...
  347800 pixels (ratio 0.38 of all image pixels) are different.

  Snapshot: zamowienia.png
    ...
    - list [ref=e6]:
      ...
      - listitem [ref=e11]:
        - link "Przetargi" [ref=e12] [cursor=pointer]:
          - /url: zamowienia.html
  - main [ref=e13]:
    - heading "Aktualne Przetargi" [level=3] [ref=e14]
    - list [ref=e15]:
      - listitem [ref=e16]:
        - text: "Dostawa oprogramowania biurowego - status:"
        - strong [ref=e17]: w toku
      - listitem [ref=e18]:
        - text: "Budowa przedszkola gminnego - status:"
        - strong [ref=e19]: rozstrzygnięty
```
